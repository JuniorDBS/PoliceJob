...
-- A modifier selon vos véhicules
            if ESX.PlayerData.job.grade_name == 'recruit' or ESX.PlayerData.job.grade_name == 'officer' or ESX.PlayerData.job.grade_name == 'sergeant' or ESX.PlayerData.job.grade_name == 'lieutenant' or ESX.PlayerData.job.grade_name == 'boss' then 
                    ...
                    if (Selected) then
                    Citizen.Wait(1)  
                    spawnuniCar("police8")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
                    RageUI.CloseAll()
                    end
                end)
            end
            ...
            if ESX.PlayerData.job.grade_name == 'officer' or ESX.PlayerData.job.grade_name == 'sergeant' or ESX.PlayerData.job.grade_name == 'lieutenant' or ESX.PlayerData.job.grade_name == 'boss' then 
                ...
                if (Selected) then
                Citizen.Wait(1)  
                spawnuniCar("police2")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
                RageUI.CloseAll()
                end
            end)
        end
        ...
        if ESX.PlayerData.job.grade_name == 'sergeant' or ESX.PlayerData.job.grade_name == 'lieutenant' or ESX.PlayerData.job.grade_name == 'boss' then 
                ...
                if (Selected) then
                Citizen.Wait(1)  
                spawnuniCar("police3")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
                RageUI.CloseAll()
                end
            end)
                ...
                if (Selected) then
                Citizen.Wait(1)  
                spawnuniCar("policeb")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
                RageUI.CloseAll()
                end
            end)
        end
        ...
        if ESX.PlayerData.job.grade_name == 'lieutenant' or ESX.PlayerData.job.grade_name == 'boss' then 
            ...
            RageUI.ButtonWithStyle("Lieutenant - VIR", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
                if (Selected) then
                Citizen.Wait(1)  
                spawnuniCar("ghispo2")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
                RageUI.CloseAll()
                end
            end)
        end
        ...
        RageUI.ButtonWithStyle("Commandant - VIR 2", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
            if (Selected) then
            Citizen.Wait(1)  
            spawnuniCar("rmodgt63police")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
            RageUI.CloseAll()
            end
        end)
    end
        ...
        RageUI.ButtonWithStyle("Véhicule Blindé", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
            if (Selected) then
            Citizen.Wait(1)  
            spawnuniCar("riot")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
            RageUI.CloseAll()
            end
        end)
    end
    ...
    if ESX.PlayerData.job.grade_name == 'recruit' or ESX.PlayerData.job.grade_name == 'officer' or ESX.PlayerData.job.grade_name == 'sergeant' or ESX.PlayerData.job.grade_name == 'lieutenant' or ESX.PlayerData.job.grade_name == 'boss' then 
        ...
        RageUI.ButtonWithStyle("Véhicule Commandement mobile", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
            if (Selected) then
            Citizen.Wait(1)  
            spawnuniCar("swatbrickade")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
            RageUI.CloseAll()
            end
        end)
    end
...
function spawnuniCar(car)
    ...
    local plaque = "LSPD"..math.random(1,9)-- Nom de la plaque à changez suivant vos envies
  ...
  Citizen.CreateThread(function()
      while true do
          RageUI.IsVisible(RMenu:Get('garageheli', 'main'), true, true, true, function() 
              ...
              if (Selected) then
              Citizen.Wait(1)  
              spawnuniCarre("as350")-- A changer suivant le nom de votre voiture (se trouve dans le vehicle.meta de votre véhicule)
              RageUI.CloseAll()
              end
          end)
